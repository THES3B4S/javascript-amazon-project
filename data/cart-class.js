class Cart {
    ...
    removeFromCart(productId) { //funcion que acepta como parametro el product.id
        this.cartItems.splice(this.cartItems.findIndex(cartItem => cartItem.id === productId), 1); //recorre el carrito y en el parametro 1 va el index, en este caso encontramos el index con findIndex(condicion). parametro 2 campos a borrar: 1
